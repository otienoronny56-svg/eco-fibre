...
const Footer = () => {
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    e.preventDefault();
    if (!email) return;
    const message = encodeURIComponent(`Hello Eco-Fibre! I would like to subscribe to your newsletter. My email is: ${email}`);
    window.open(`https://wa.me/254710172828?text=${message}`, '_blank');
  };
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-base leading-relaxed">
              The leading provider of reliable, high-speed fiber internet and professional CCTV installation solutions in Rongo Town, Awendo, and Kisii. Connecting and securing South Nyanza.
            </p>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
              <input 
                ...
                className="bg-white/5 border border-white/10 rounded-xl px-5 py-3 focus:outline-none focus:border-primary-orange w-full text-base" 
              />
              <button 
                type="submit"
                className="orange-gradient w-full py-3 rounded-xl font-bold text-base shadow-lg shadow-orange-500/20 hover:scale-105 transition-transform"
              >
                Join Now
              </button>
            </form>
